...
class InternshipCache {
    ...
    checkIfNewInternship(position) {
      /*for(let i = 0; i < this.internships.length; i++) {
        if (this.internships[i].company == position.company && this.internships[i].position == position.position && this.internships[i].description == position.description && this.internships[i].locations == position.locations) {
          return false
        }
      }*/
      return true
  ...
  class InternshipLoader {
      ...
      schoolYearBank = ["Freshman", "Sophmore", "Junior", "Senior", "Undergraduate", "Graduate", "PhD"]
      getschoolYearBank() {
      ...
      locateSchoolYears(description) {
          schoolYearInfo = description.toLowerCase()
          let schoolYearInfo = []
          schoolYears [0] = "null"
     ...
     readLines(filePath) {
      ...
      loadCache(filePath) {
          ...
          /*
          let lines = this.readLines(filePath)
          console.log("here")
          console.log(lines)
       ...
       */
        ...
        cache.newInternship("PRACTICE Benefit Corp", "https://static.licdn.com/aero-v1/sc/h/9rxpcj33wtsq3w7nxb3u3ku6e","NYC K-12 Tutors for all Boroughs", 192720.0, ["Android"], "NYC K-12 Tutors for all Boroughs", "https://www.linkedin.com/jobs/view/nyc-k-12-tutors-for-all-boroughs-at-practice-benefit-corp-3801471301", [""], ["NY"])
        cache.newInternship("Samsung", "logo","Data scientist", 10000, ["Android"], "test", "https://intern-ally.co/", ["Data Science"], ["USA"])
        cache.newInternship("Samsung", "logo","Data scientist", 10000, ["Android"], "test", "https://intern-ally.co/", ["Data Science"], ["USA"])
...
function print_postings() {
    ...
    myFilteredCache.internships.forEach(function(item) {
        ...
        whiteBoxElement.className = "white-box";
        ...
        whiteBoxElement.appendChild(headElement);
        whiteBoxElement.appendChild(job_info_div);
        whiteBoxElement.appendChild(job_logo_div);

        divElement.appendChild(whiteBoxElement);
