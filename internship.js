...
export class InternshipLoader {
    ...
    let locationBank = ["New York City, NY", "Los Angeles, CA", "Chicago, IL", "Houston, TX", "Phoenix, AZ", "Philadelphia, PA", "San Antonio, TX", "San Diego, CA", "Dallas, TX", "San Jose, CA", "Austin, TX", "Jacksonville, FL", "Fort Worth, TX", "Columbus, OH", "San Francisco, CA", "Charlotte, NC", "Indianapolis, IN", "Seattle, WA", "Denver, CO", "Washington, DC", "Boston, MA", "El Paso, TX", "Nashville, TN", "Detroit, MI", "Oklahoma City, OK", "Portland, OR", "Las Vegas, NV", "Memphis, TN", "Louisville, KY", "Baltimore, MD", "Milwaukee, WI", "Albuquerque, NM", "Tucson, AZ", "Fresno, CA", "Mesa, AZ", "Sacramento, CA", "Atlanta, GA", "Kansas City, MO", "Colorado Springs, CO", "Omaha, NE", "Raleigh, NC", "Miami, FL", "Long Beach, CA", "Virginia Beach, VA", "Oakland, CA", "Minneapolis, MN", "Tulsa, OK", "Arlington, TX", "Tampa, FL", "New Orleans, LA", "Wichita, KS", "Bakersfield, CA", "Cleveland, OH", "Tampa, FL", "Aurora, CO", "Anaheim, CA", "Honolulu, HI", "Santa Ana, CA", "Riverside, CA", "Corpus Christi, TX", "Lexington, KY", "Stockton, CA", "St. Louis, MO", "St. Paul, MN", "Henderson, NV", "Pittsburgh, PA", "Cincinnati, OH", "Anchorage, AK", "Greensboro, NC", "Plano, TX", "Newark, NJ", "Lincoln, NE", "Toledo, OH", "Orlando, FL", "Chula Vista, CA", "Irvine, CA", "Fort Wayne, IN", "Jersey City, NJ", "Durham, NC", "St. Petersburg, FL", "Laredo, TX", "Buffalo, NY", "Madison, WI", "Lubbock, TX", "Chandler, AZ", "Scottsdale, AZ", "Reno, NV", "Glendale, AZ", "Norfolk, VA", "Winston-Salem, NC", "North Las Vegas, NV", "Gilbert, AZ", "Chesapeake, VA", "Irving, TX", "Hialeah, FL", "Garland, TX", "Fremont, CA", "Richmond, VA", "Boise City, ID", "Baton Rouge, LA", "Des Moines, IA", "Spokane, WA", "San Bernardino, CA", "Modesto, CA", "Tacoma, WA", "Fontana, CA", "Santa Clarita, CA", "Birmingham, AL", "Oxnard, CA", "Fayetteville, NC", "Moreno Valley, CA", "Rochester, NY", "Glendale, CA", "Huntington Beach, CA", "Salt Lake City, UT", "Grand Rapids, MI", "Amarillo, TX", "Yonkers, NY", "Aurora, IL", "Montgomery, AL", "Akron, OH", "Little Rock, AR", "Huntsville, AL", "Augusta, GA", "Port St. Lucie, FL", "Grand Prairie, TX", "Columbus, GA", "Tallahassee, FL", "Overland Park, KS", "Tempe, AZ", "McKinney, TX", "Mobile, AL", "Cape Coral, FL", "Shreveport, LA", "Frisco, TX", "Knoxville, TN", "Worcester, MA", "Brownsville, TX", "Vancouver, WA", "Fort Lauderdale, FL", "Sioux Falls, SD", "Ontario, CA", "Chattanooga, TN", "Providence, RI", "Newport News, VA", "Rancho Cucamonga, CA", "Santa Rosa, CA", "Peoria, AZ", "Springfield, MO", "Fontana, CA", "Cary, NC", "Eugene, OR", "Fort Collins, CO", "Corona, CA", "Garden Grove, CA", "Hayward, CA", "Lancaster, CA", "Alexandria, VA", "Salinas, CA", "Palmdale, CA", "Joliet, IL", "Naperville, IL", "Pasadena, TX", "Rockford, IL", "Pomona, CA", "Hollywood, FL", "Kansas City, KS", "Escondido, CA", "Clarksville, TN", "Sunnyvale, CA", "Macon, GA", "Pembroke Pines, FL", "Paterson, NJ", "Torrance, CA", "Bridgeport, CT", "Savannah, GA", "Mesquite, TX", "Syracuse, NY", "Orange, CA", "Pasadena, CA", "Fullerton, CA", "Killeen, TX", "Dayton, OH", "McAllen, TX", "Bellevue, WA", "Miramar, FL", "Hampton, VA", "West Valley City, UT", "Warren, MI", "Olathe, KS", "Columbia, SC", "Thornton, CO", "New Haven, CT", "Waco, TX", "Charleston, SC", "Thousand Oaks, CA", "Visalia, CA", "Cedar Rapids, IA", "Elizabeth, NJ", "Roseville, CA", "Gainesville, FL", "Carrollton, TX", "Stamford, CT", "Denton, TX", "Midland, TX", "Coral Springs, FL", "Concord, CA", "Topeka, KS", "Simi Valley, CA", "Surprise, AZ", "Lafayette, LA", "Kent, WA", "Hartford, CT", "Santa Clara, CA", "Victorville, CA", "Abilene, TX", "Murfreesboro, TN", "Evansville, IN", "Vallejo, CA", "Athens, GA", "Allentown, PA", "Berkeley, CA", "Norman, OK", "Ann Arbor, MI", "Beaumont, TX", "Independence, MO", "El Monte, CA", "Springfield, IL", "Fargo, ND", "Wilmington, NC", "Arvada, CO", "South Bend, IN", "Peoria, IL", "Lansing, MI", "Odessa, TX", "Richardson, TX", "Fairfield, CA", "Elgin, IL", "Round Rock, TX", "Clearwater, FL", "Carlsbad, CA", "Springfield, MA", "West Jordan, UT", "Costa Mesa, CA", "Wichita Falls, TX", "Miramar, FL", "Charleston, WV", "Syracuse, NY", "Metairie, LA", "Hialeah, FL"]
